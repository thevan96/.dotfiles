...
let s:palette.bg        = {'dark': "#0F1419",  'light': "#FAFAFA",  'mirage': "#202020"}
...
let s:palette.guide     = {'dark': "#2D3640",  'light': "#D9D8D7",  'mirage': "#5C6773"}
...
let s:palette.fg_idle   = {'dark': "#3E4B59",  'light': "#828C99",  'mirage': "#F0EEE4"}
